...
public class SpriteAnimator : MonoBehaviour
{
    ...
    public bool loop = false; // Should the animation loop?
    ...
    void Start()
    {
        ...
        {
            Debug.Log("No Image component found on this GameObject!");
        }   

        if (sprites == null || sprites.Count == 0)
        {
            Debug.Log("No sprites assigned to the SpriteAnimator!");
        }
    }
